...
protected:
	...
	float SlotGap = 5.f;           // отступ между €чейками
	...
	UPROPERTY(meta = (BindWidgetOptional))
	UHorizontalBox* DragHandle = nullptr; // верхн€€ панель/шапка окна (можно любой виджет)
